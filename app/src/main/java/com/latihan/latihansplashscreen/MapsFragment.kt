...
class MapsFragment : Fragment(), OnMapReadyCallback {
    ...
    // Default location: Kampus STIKOM Poltek Cirebon, Kedawung
    private val defaultLocation = LatLng(-6.7114, 108.5306)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        addMarker(defaultLocation, "Kampus STIKOM Cirebon")
